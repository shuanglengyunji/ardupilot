...
SPIDesc SPIDeviceManager::_device[] = {
    SPIDesc("icm20948",    0, 0, SPI_MODE_0, 8, SPI_CS_KERNEL,  1*MHZ, 11*MHZ),
    SPIDesc("ublox",      0, 1, SPI_MODE_0, 8, SPI_CS_KERNEL,  5*MHZ, 5*MHZ),
    // SPIDesc("mpu9250",    0, 0, SPI_MODE_0, 8, SPI_CS_KERNEL,  1*MHZ, 11*MHZ),
