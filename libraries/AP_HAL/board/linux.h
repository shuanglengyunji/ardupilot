...
#define PROBE_MAG_IMU_I2C(driver, imudev, bus, addr, args ...) ADD_BACKEND(DRIVER_ ##driver, AP_Compass_ ## driver::probe_ ## imudev(GET_I2C_DEVICE(bus,addr),##args))
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    // BARO
    #define BARO_PROBE_BMP280_IIC PROBE_BARO_I2C(BMP280, 1, 0x76)
    #define BARO_PROBE_MS56XX_IIC PROBE_BARO_I2C(MS56XX, 1, 0x77)
    #define BARO_PROBE_LPS2XH_IIC PROBE_BARO_I2C(LPS2XH, 1, 0x5C)
    #define HAL_BARO_PROBE_LIST BARO_PROBE_BMP280_IIC; BARO_PROBE_MS56XX_IIC; BARO_PROBE_LPS2XH_IIC

    // INS
    #define INS_PROBE_MPU9250_SPI PROBE_IMU_SPI(Invensense, "mpu9250", ROTATION_NONE)
    #define INS_PROBE_MPU9250_IIC PROBE_IMU_I2C(Invensense, 1, 0x68, ROTATION_NONE)
    #define INS_PROBE_ICM20948_SPI PROBE_IMU_SPI(Invensensev2, "icm20948", ROTATION_NONE)
    #define INS_PROBE_ICM20948_IIC PROBE_IMU_I2C(Invensensev2, 1, 0x68, ROTATION_NONE)
    #define HAL_INS_PROBE_LIST INS_PROBE_MPU9250_SPI; INS_PROBE_MPU9250_IIC; INS_PROBE_ICM20948_IIC; INS_PROBE_ICM20948_SPI

    // MAG
    #define MAG_PROBE_AK8963_SPI PROBE_MAG_IMU(AK8963, mpu9250, 0, ROTATION_NONE)
    #define MAG_PROBE_AK8963_IIC PROBE_MAG_IMU_I2C(AK8963, mpu9250, 1, 0x0c, ROTATION_NONE)
    #define MAG_PROBE_AK09916_SPI PROBE_MAG_IMU(AK09916, ICM20948, 0, ROTATION_NONE)
    #define MAG_PROBE_AK09916_IIC PROBE_MAG_IMU_I2C(AK09916, ICM20948, 1, 0x0c, GET_I2C_DEVICE(1, 0x68), false, ROTATION_NONE)
    #define HAL_MAG_PROBE_LIST MAG_PROBE_AK8963_SPI; MAG_PROBE_AK8963_IIC; MAG_PROBE_AK09916_SPI; MAG_PROBE_AK09916_IIC
